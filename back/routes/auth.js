...
router.post('/register', [
    ...
    body('email').custom(value => {
        return helper.database.table('users').filter({
            ...
            if (user) {
                console.log(user);
                return Promise.reject('Email / l email existe.');
            }
        })
    })
], async (req, res) => {
    ...
    if (!errors.isEmpty()) {
        ...
        let photoUrl = req.body.photoUrl === null ? 'https://lh3.googleusercontent.com/proxy/wz2ZBNP_e7TbxFP9KV4trfYOCQF_x4-nWOn_epRZfnl70cENzKZXxPNHyp3UKDr8UjRaTT5YSsabXKgyIWoOj6aLTshjjqE2gYyH7zzCAr7YFqfh4aUxASir9nzF0psp63TRaD80UITG31xdXw' : req.body.photoUrl
